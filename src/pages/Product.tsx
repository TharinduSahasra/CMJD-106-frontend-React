...
function Product() {
    ...
    const [qty, setQty] = useState<number>(0.0);
        ...
        <div className="container mx-auto pt-5 pb-5">
            ...
            <table className="w-full border-separate border-spacing-0 border-none text-left">
                <thead className="bg-slate-200">
                    <tr>
                        ...
                        <th className="w-[200px]">Product Quntity</th>
            ...
            <div className="border border-slate-200 py-3 px-4 rounded-lg max-w-[350px]">
                <form>
                    ...
                    <div>
                        <label className="text-slate-600 font-sm block mb-2">Quntity</label>
                        <input type="text" className="text-slate-600 font-sm block mb-3 w-full p-2 border border-slate-300 rounded-lg" value={qty} onChange={handleQty} required />
                    </div>
